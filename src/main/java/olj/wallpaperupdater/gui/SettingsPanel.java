...
import olj.wallpaperupdater.gui.components.DoubleTextField;
import olj.wallpaperupdater.gui.components.Label;
import olj.wallpaperupdater.gui.components.Panel;
import olj.wallpaperupdater.gui.components.RadioButton;
...
public class SettingsPanel extends Panel {
	...
	private EngineModeRadioButton getSelectedEngineRB() {
		...
		throw new RuntimeException("Operation failure; a wallpaperupdater.engine mode should always be selected");
	}
